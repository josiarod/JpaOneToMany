...
import com.example.jpa.exeption.ResourceNotFoundExcption;
...
public class CommentController {
    ...
    public Comment updateComment(@PathVariable (value = "postId") Long postId,
        ...
        return commentRepository.findById(commentId).map(comment -> {
            ...
            return commentRepository.save(comment);
        }).orElseThrow(() -> new ResourceNotFoundExcption("CommentId " + commentId + "notfound"));
    }
    ...
    public ResponseEntity<?> deleteComment(@PathVariable (value = "postId") Long postId,
        ...
        }).orElseThrow(() -> new ResourceNotFoundExcption("Comment not found with id " + commentId + " and postId " + postId));
    }
}
